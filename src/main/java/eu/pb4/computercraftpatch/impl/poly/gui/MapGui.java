...
import eu.pb4.computercraftpatch.impl.poly.render.CanvasRenderer;
import eu.pb4.computercraftpatch.impl.poly.render.ImageButton;
import eu.pb4.computercraftpatch.impl.poly.render.ScreenElement;
...
public class MapGui extends HotbarGui {
    ...
    public MapGui(ServerPlayerEntity player) {
        ...
        this.virtualDisplay = VirtualDisplay.of(this.canvas, pos.offset(dir).offset(dir.rotateYClockwise(), 2).up(), dir, 0, true);
        ...
        this.entity = new HorseEntity(EntityType.HORSE, PolymerUtils.getFakeWorld());
        ...
        this.cursor = this.canvas.createIcon(MapIcon.Type.TARGET_POINT, true, this.cursorX, this.cursorY, (byte) 14, null);
        player.networkHandler.sendPacket(this.entity.createSpawnPacket());
        player.networkHandler.sendPacket(new EntityS2CPacket.Rotate(this.entity.getId(), (byte) 0, (byte) 0, player.isOnGround()));
        player.networkHandler.sendPacket(new EntitySetHeadYawS2CPacket(this.entity, (byte) 0));
        ...
        player.networkHandler.sendPacket(VirtualEntityUtils.createRidePacket(this.entity.getId(), IntList.of(player.getId())));
    ...
    public void render() {
        this.renderer.render(this.player.getWorld().getTimeOfDay(), this.cursorX / 2, this.cursorY / 2);
        // Debug maps
