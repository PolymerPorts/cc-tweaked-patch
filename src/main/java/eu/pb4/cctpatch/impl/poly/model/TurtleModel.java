...
import eu.pb4.cctpatch.mixin.TurtleToolInvoker;
...
public class TurtleModel extends BlockModel {
    ...
    private ItemStack getUpgradeModel(ITurtleUpgrade upgrade, TurtleBrain brain, TurtleSide turtleSide) {
        ...
        } else if (upgrade instanceof TurtleToolInvoker) {
            return ((TurtleToolInvoker) upgrade).getToolStack(brain, turtleSide);
        }
